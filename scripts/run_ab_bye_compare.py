...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--stub-model-provider", choices=["fake", "openai", "openai_compat", "gemini", "qwen", "deepseek", "glm"], default="fake")
    parser.add_argument("--real-model-provider", choices=["fake", "openai", "openai_compat", "gemini", "qwen", "deepseek", "glm"], default="fake")
